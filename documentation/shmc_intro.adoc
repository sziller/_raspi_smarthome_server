...
=== Motivation
Soverignity will have to be achieved on two different levels:
...
[IMPORTANT]
====
Soverignity is hard to achieve. You obviously *can* anytime use 3rd party software if you choose to. +
